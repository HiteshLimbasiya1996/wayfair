...
= 1.6.7 =
  ...
  -- Added go pro button in slider, footer and services section in customizer.
  -- Updated language folder.
...
= 1.7.5 =
  ...
  -- Added default button text for slider and services section.
  -- Update language folder.
...
= 1.8.4 =
  ...
  -- Resolved get started redirection issue. 
...
= 1.8.8 =
  -- Resolved title css for service section.
  -- Resolved css for slider in responsive media.
...
= 1.9.1 =
  ...
  -- Added dropdown categories widgets for sidebar preview.
  -- Update pot file.
...
== Theme Documentation ==
Documentation : https://preview.vwthemesdemo.com/docs/free-vw-hospital-lite/