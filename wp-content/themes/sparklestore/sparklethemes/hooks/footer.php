		       		...
		       		<div class="coppyright">
						<?php 
							...
							if ( apply_filters( 'sparklsestore_credit_link', true ) ) { 
								...
								printf( esc_html__( '%1$s By %2$s', 'sparklestore' ), ' WordPress Theme : SparkleStore ', '<a href=" ' . esc_url('https://sparklewp.com/free-woocommerce-wordpress-themes/') . ' " rel="designer" target="_blank">'.esc_html__('WooCommerce Themes','sparklestore').'</a>' );
